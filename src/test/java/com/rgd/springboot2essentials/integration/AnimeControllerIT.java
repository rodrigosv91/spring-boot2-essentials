package com.rgd.springboot2essentials.integration;

import com.rgd.springboot2essentials.domain.Anime;
import com.rgd.springboot2essentials.repository.AnimeRepository;
import com.rgd.springboot2essentials.util.AnimeCreator;
import com.rgd.springboot2essentials.wrapper.PageableResponse;
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("user2", "senha");
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:" + port)
                    .basicAuthentication("rodrigo2", "senha");
